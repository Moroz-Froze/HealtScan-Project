...
function Be(e, t) {
  ...
  const r2 = typeof t == "function" ? t : (n) => {
    const { method: a3, version: o } = n, s = "param" in n ? new he2(a3, n.param, o) : new be2(a3, o);
    if (t === "strict")
      throw s;
...
function Tn(e) {
  e || (e = {});
  const { postEvent: t } = e, o = e.launchParams || ke2();
  oo.set(o), Bo.set(
    typeof t == "function" ? t : Be(o.tgWebAppVersion)
...
function jr() {
  const e = ke2();
  Wo.set(e.tgWebAppData), Hr.set(Oe());
}
